...
INSERT INTO `menu_item` (`id`, `shop_id`, `name`, `base_price`, `is_active`, `created_at`, `updated_at`)
VALUES ('item_awarin_krapao', 'shop_awarin', 'กะเพรา', 5000, 1, unixepoch(), unixepoch()); -- 50.00 THB base

INSERT INTO `modifier_group` (`id`, `menu_item_id`, `name`, `selection_type`, `is_required`, `created_at`, `updated_at`)
VALUES
...
INSERT INTO `modifier_option` (`id`, `modifier_group_id`, `name`, `price_delta`, `created_at`, `updated_at`)
VALUES
